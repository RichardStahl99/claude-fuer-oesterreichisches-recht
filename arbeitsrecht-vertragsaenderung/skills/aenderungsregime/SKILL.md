...
- **Normen (über RIS auflösen, `tools/ris_client.py`):** § 863, § 914, § 915 ABGB (Konsens, Auslegung, Unklarheitenregel) — GNR 10001622; §§ 861, 883 ABGB (Konsensualprinzip/Formfreiheit: Arbeitsverträge sind grundsätzlich formfrei; Bindung durch Annahme) — GNR 10001622; § 2 AVRAG (Dienstzettel-Pflicht: schriftliche Aufzeichnung der wesentlichen Rechte und Pflichten aus dem Arbeitsvertrag; geltende Fassung idF BGBl I 11/2024 — EU-Transparenz-Novelle; Formerfordernis für den Dienstzettel, nicht für den Vertrag selbst), § 7a AVRAG (Verwaltungsstrafe der Bezirksverwaltungsbehörde bei Nichtaushändigung des Dienstzettels) — GNR 10008872 [nicht § 1163 ABGB; § 1163 ABGB regelt das Dienstzeugnis]; § 20 AngG (Kündigungsfristen — relevant, weil die Änderungskündigung eine echte Kündigung ist: 6 Wochen bis 5 Monate, zum Quartal) — GNR 10008069 (Artikel 1); § 101, § 105, § 107 ArbVG (Mitwirkung bei Versetzungen/Verschlechterungsschutz [§ 101 — kollektiver Prong, setzt Betriebsrat voraus]; Kündigungsanfechtung [§ 105]; Anfechtung durch den Arbeitnehmer im betriebsratslosen Betrieb [§ 107 iVm § 105 Abs 4a]) — GNR 10008329.
