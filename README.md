...
- [x] **Phase 5 — Arbeitsrecht-Vertikale** `arbeitsrecht-beendigung`: 6 Skills — Beendigungsart → Kündigungsfristen (§ 20 AngG, § 1159 ABGB) → Kündigungsschutz/Anfechtung (§ 105 ArbVG, Betriebsrat, ASG, 2-Wochen-Frist) → Beendigungsansprüche (Abfertigung neu/alt, § 10 UrlG, § 29 AngG) + Test-Akte `testakten/kuendigung-angestellte-anfechtung/`. Grundlagen weiterhin **unverändert**; `ris_client.py` um AngG/ArbVG/BMSVG/ASGG/UrlG ergänzt (inkl. AngG-Artikel-Adressierung).
- [ ] Danach: Gesellschaftsrecht (UGB/GmbHG + Notariatsakt), Berufsrecht (RAO), Familienrecht/Außerstreit, Insolvenz (IO).
