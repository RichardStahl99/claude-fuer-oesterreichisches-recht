...
| Behelf | Stufe 1 (Verbesserung/Austausch) verweigert → **Sprung auf Stufe 2** zulässig; Mangel nicht geringfügig → **Vertragsauflösung oder Preisminderung** (§ 13 VGG) | `behelfshierarchie` |
...
| Zuständigkeit | Streitwert 649 € → **BG Linz**; < 5.000 € → keine absolute Anwaltspflicht (relativ, § 27 ZPO) | JN |
...
3. **Behelf:** Primär schuldet der Händler Verbesserung oder Austausch (§ 12 VGG). Da er beides **verweigert**, kann Frau Huber auf die zweite Stufe wechseln und **Preisminderung oder Vertragsauflösung** verlangen (§ 13 VGG; die Vertragsauflösung entspricht der Wandlung des ABGB). Wegen Unbrauchbarkeit ist der Mangel nicht geringfügig → **Vertragsauflösung** (Rückabwicklung gegen Kaufpreis) ist eröffnet.
4. **Frist:** Die zweijährige Gewährleistungsfrist (ab Übergabe 20.03.2025) ist gewahrt; die gesonderte 3-Monats-Verjährungsfrist des § 10 VGG ist hier nicht einmal relevant.
...
- Behelfshierarchie/Verbesserung — `RIS-Justiz RS0018921` (OGH 1 Ob 621/55, Linie laufend bestätigt)
